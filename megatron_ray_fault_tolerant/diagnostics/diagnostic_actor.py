...
This actor is completely independent of any application-specific code (like MegatronActor).
It can be spawned on any GPU to run diagnostic tests and manages its own NCCL process group.
"""
...
class DiagnosticActor:
    ...
    def run_gpu_health_check(self, simulation_mode: bool = False) -> Dict[str, Any]:
        """
        Phase 1: Check GPU health via nvidia-smi and simple CUDA operation.

        Args:
            simulation_mode: If True, return success without running real tests
    ...
    def run_intra_node_comm_test(self, simulation_mode: bool = False) -> Dict[str, Any]:
        """
    ...
    def run_inter_node_comm_test(self, simulation_mode: bool = False) -> Dict[str, Any]:
        """
