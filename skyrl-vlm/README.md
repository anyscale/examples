...
Geometry-3K contains 3,002 geometry problems with diagrams; the model must reason over both the image and the problem text. The reward is 1.0 for a correct answer and 0.0 otherwise.
